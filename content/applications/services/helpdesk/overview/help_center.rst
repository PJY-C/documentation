...
To activate any *Help Center* features (**Forums**, **eLearning**, or **Knowledge**) on a *Helpdesk*
team, go to :menuselection:`Helpdesk app --> Configuration --> Helpdesk Teams` and select a team, or
...
Additionally, the :guilabel:`Website Form` option on the **Helpdesk** team page **must** be enabled
